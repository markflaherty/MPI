...
Description: This is an implementation of the sieve algorithm.
This algorithm is preferable for allowing processes to not have to
communicate full arrays, and benefits from the characteristics 
of prime numbers. 
*/
